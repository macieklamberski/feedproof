...
const result = transformContent(html, {
  ...
  // <video>/<audio> elements (defaults: YouTube, Vimeo, Dailymotion, JW Player and
  // Buzzsprout embeds, plus the media resolvers for Substack, WeChat, Weebly and Ghost uploads).
