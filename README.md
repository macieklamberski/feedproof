...
| `flattenPictureElements` | Collapse `<picture>` to a single `<img>`, promoting the best modern-format (AVIF/WebP) source and carrying the picture/source dimensions onto the img when it has none |
