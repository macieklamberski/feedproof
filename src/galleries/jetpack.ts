...
// Jetpack slideshow block. Slides are li.swiper-slide > figure > img; the
// navigation arrows and pagination bullets carry no <img>, so a plain image
// walk yields only slide images.
