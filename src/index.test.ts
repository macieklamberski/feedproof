    ...
    describe('Substack', () => {
      ...
      it('should keep a populated Image2ToDOM anchor as a dimensioned, proxied image', async () => {
        ...
        const result = await transformContent(value, {
          ...
          assetProxyFn: (url, type) =>
            `https://proxy.example.com/${type}/${encodeURIComponent(url)}`,
        })
      ...
      it('should convert a DatawrapperToDOM chart into its static image', async () => {
        ...
        const chartAttrs = substackAttrs({
          ...
          thumbnail_url:
            'https://substack-post-media.s3.amazonaws.com/public/images/a_1220x1742.png',
          height: 536,
      ...
      it('should resolve a BandcampToDOM wrap into a bandcamp embed placeholder', async () => {
        ...
        const bandcampAttrs = substackAttrs({
          ...
          thumbnail_url:
            'https://substack-post-media.s3.amazonaws.com/public/images/b_700x700.jpeg',
          author: 'Example Band',
          embed_url:
