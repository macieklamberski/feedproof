...
describeForEachParser('dailymotionEmbedResolver', (parseHtml) => {
  ...
  // The host check is what refused this, not the path reader. The French apex answers 200 and
  // then redirects to a language landing page, dropping the video, so the id is worth more than
