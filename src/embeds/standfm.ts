...
// A single episode and a whole channel are different players and different sizes, so the kind
// is carried into the id rather than flattened away. Both discriminate, which is what makes them
// worth minting: a real id answers 200 (42,705 bytes for the episode, 72,908 for the channel)
// and a fabricated one answers 404, and neither sends `x-frame-options` (probed 2026-08-16).
