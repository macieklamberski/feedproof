...
describeForEachParser('weeblyMediaResolver', (parseHtml) => {
  ...
  describe('happy paths', () => {
    ...
    it('should build the video url from the poster', () => {
      const value = facade(
    ...
    it('should take the uploads url rather than the play icon', () => {
      const value = facade(
  ...
  describe('sad paths', () => {
    ...
    it('should ignore a wrapper holding a live third-party iframe', () => {
      const value = html`
    ...
    it('should ignore a wrapper another pass already resolved', () => {
      const value = html`
        <div class="wsite-video-wrapper">
