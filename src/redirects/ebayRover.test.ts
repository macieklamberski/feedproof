...
import { extractEbayRover } from './ebayRover.js'

describe('extractEbayRover', () => {
  it('should extract target from mpre param on rover.ebay.com', () => {
    ...
    expect(extractEbayRover(url)).toBe('https://www.ebay.com/itm/123')
  })
  ...
  it('should match country-code TLDs (rover.ebay.co.uk)', () => {
    ...
    expect(extractEbayRover(url)).toBe('https://www.ebay.co.uk/itm/456')
  })
