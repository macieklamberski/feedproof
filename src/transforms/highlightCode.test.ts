...
describe('highlightCode', () => {
  it('should highlight code block with language-js class', () => {
    const html = '<pre><code class="language-js">const x = 1</code></pre>'
    const result = transformHtml(html, highlightCode(context))
  ...
  it('should highlight code block with lang-python class', () => {
  ...
  it('should auto-detect language when no class is present', () => {
    const html = '<pre><code>function greet(name) {\n  return "Hello, " + name;\n}</code></pre>'
    const result = transformHtml(html, highlightCode(context))
  ...
  it('should not touch inline code outside pre', () => {
    const html = '<p>Use <code>const x = 1</code> to declare a variable</p>'
    const result = transformHtml(html, highlightCode(context))
  ...
  it('should not touch empty code blocks', () => {
  ...
  it('should not touch whitespace-only code blocks', () => {
    const html = '<pre><code>   \n  </code></pre>'
    const result = transformHtml(html, highlightCode(context))
  ...
  it('should fall back to auto-detection for unsupported language', () => {
    const html = '<pre><code class="language-nonexistent">const x = 1</code></pre>'
    const result = transformHtml(html, highlightCode(context))
  ...
  it('should not modify pre without code element', () => {
  ...
  it('should highlight Shiki code blocks using data-language on pre', () => {
    const html = [
