...
describeForEachParser('hoistFigcaptionFromAnchor', (parseHtml) => {
  ...
  it('should move figcaption out when the anchor wraps a picture', async () => {
    const value =
      '<figure><a href="big.jpg"><picture><source srcset="small.webp"><img src="small.jpg"></picture><figcaption>caption</figcaption></a></figure>'
    const expected =
      '<figure><a href="big.jpg"><picture><source srcset="small.webp"><img src="small.jpg"></picture></a><figcaption>caption</figcaption></figure>'
  ...
  it('should preserve the anchor href and media when hoisting', async () => {
    const value =
      '<figure><a href="big.jpg" target="_blank"><img src="small.jpg" alt="art"><figcaption>caption</figcaption></a></figure>'
  ...
  it('should leave a link inside the caption untouched', async () => {
    const value =
      '<figure><img src="small.jpg"><figcaption>see <a href="src.html">source</a></figcaption></figure>'
  ...
  it('should leave a caption nested deeper than the anchor direct child untouched', async () => {
    const value =
      '<figure><a href="big.jpg"><div><img src="small.jpg"><figcaption>caption</figcaption></div></a></figure>'
